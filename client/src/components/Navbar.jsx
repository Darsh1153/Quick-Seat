...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      gap-8 min-md:px-8 py-3 max-md:min-h-screen md:rounded-full backdrop-blur bg-black/70 md:bg-white/10
      ...
      <MenuIcon onClick={() => setIsOpen(!isOpen)} className='md:hidden max-md:ml-4 w-8 h-8 cursor-pointer' />
    </div>
  )
}
